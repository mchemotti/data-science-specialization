...
# 
# What shall I call you? Marissa
# 
# | Thanks, Marissa. Let's cover a couple of quick housekeeping items before we begin our first lesson. First
...
# Selection: Basic Building Blocks
# Enter an item from the menu, or 0 to exit
# Selection: 1
# 
...
# 
# |================                                                                                   |  16%
# | Think of the assignment operator as an arrow. You are assigning the value on the right side of the arrow
# | to the variable name on the left side of the arrow.
# 
# ...
# 
# |==================                                                                                 |  18%
...
# | assumes that you don't want to see the result immediately, but rather that you intend to use the result
...
# 
# > c(1, 2, 3, 4) + c(0 10)
# Error: unexpected numeric constant in "c(1, 2, 3, 4) + c(0 10"
# > c(1, 2, 3, 4) + c(0, 10)
# [1]  1 12  3 14
# 
...
# | still apply the 'recycling' method, but will throw a warning to let you know something fishy might be
# | going on.
# 
# ...
# 
...
#   
#   Selection: 1
#   What is your email address? marissachemotti@gmail.com
#   What is your assignment token? D48T3HhtfncsTaua
